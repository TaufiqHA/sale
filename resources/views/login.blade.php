...
<body class="h-full bg-brand text-white font-sans overflow-x-hidden antialiased selection:bg-white selection:text-brand">
    ...
    <div class="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" class="w-full h-full opacity-90">
            <!-- Base Gradient -->
            <rect width="1440" height="900" fill="var(--color-brand)" />

            <!-- Top Left Light Waves -->
            <path d="M -100,-100 C 200,-100 400,50 350,200 C 300,350 100,400 -100,300 Z" fill="var(--color-brand-300)" opacity="0.4" />
            <path d="M -100,-100 C 100,-100 250,0 220,100 C 190,200 50,250 -100,200 Z" fill="var(--color-brand-200)" opacity="0.5" />

            <!-- Left Bottom Dark Waves -->
            <path d="M -100,1000 C 200,1000 350,850 300,600 C 250,350 50,300 -100,300 Z" fill="var(--color-brand-600)" opacity="0.5" />
            <path d="M -100,1000 C 100,1000 220,900 180,750 C 140,600 20,550 -100,550 Z" fill="var(--color-brand-800)" opacity="0.7" />

            <!-- Right Side Waves & Accent Blobs -->
            <path d="M 1540,1000 C 1200,1000 1100,800 1150,550 C 1200,300 1350,200 1540,200 Z" fill="var(--color-brand-300)" opacity="0.3" />
            <path d="M 1540,1000 C 1280,1000 1180,900 1220,700 C 1260,500 1380,400 1540,400 Z" fill="var(--color-brand-600)" opacity="0.4" />

            <!-- Top Right Soft Light Wave -->
            <path d="M 1100,-100 C 1200,50 1350,-50 1540,50 V -100 Z" fill="var(--color-brand-300)" opacity="0.3" />
        </svg>
    </div>
        ...
        <div class="w-full max-w-[360px] flex flex-col items-center">
            ...
            <form action="{{ route('login') }}" method="POST" class="w-full flex flex-col gap-4">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" class="bg-transparent border border-brand-200/50 text-white text-sm rounded-md focus:ring-2 focus:ring-white/50 focus:border-transparent block w-full px-3 py-2.5 shadow-xs placeholder:text-white/60" placeholder="name@flowbite.com" required />
                    @error('email')
                ...
                <div class="mb-5">
                    ...
                    <input type="password" name="password" id="password" class="bg-transparent border border-brand-200/50 text-white text-sm rounded-md focus:ring-2 focus:ring-white/50 focus:border-transparent block w-full px-3 py-2.5 shadow-xs placeholder:text-white/60" placeholder="••••••••" required />
                </div>
